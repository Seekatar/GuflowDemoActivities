...
.PARAMETER DockerTag
Optional tag for the docker container, leave blank for ccc-cas-workflow3-api:MM.dd.yy
...
param(
    ...
    [string] $ContainerName = "workflow3-api",
    [string] $DockerTag = "ccc-cas-workflow3-api:$((Get-Date).ToString('MM.dd.yy'))",
